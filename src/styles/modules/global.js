...
const GlobalStyle = createGlobalStyle`
  :root{   
    /* Colors */
    --color-primary: #92d400;
    --color-primary-ex: rgba(146,212,0, 0.5)
    --color-secondary: #1B1B1B;
    --color-tertiary: #f5f6f6;
    --color-quartenary: #FFCC33;
    --color-senary: #19284A;
    ...
    --color-grey-ex-1-blur: rgba(222,226,230,0.8);
    --color-grey-ex-2: #EDF2FF;
    --color-black-1: #111;
    --color-royalblue: #4169E1;
    --color-scrollbar-1: #b2bec3;
    --color-scrollbar-2: #dfe6e9;
    --color-scrollbar-3: #74b9ff;
    --color-bubbles-blue: #83af9b;
    --color-bubbles-green: #c8c8a9;
    --color-bubbles-brown: #774f38;
    --color-bubbles-beige: #ece5ce;
    --color-bubbles-yellow: #f9cdad;
    --color-bubbles-pink: #fe4365;
    --color-grey-0: #F8F9FA;
    --color-grey-1: #121214;
    --color-grey-2: #212529;
    --color-grey-3: #343B41;
    ...
    --font-quartenary-alkatra: 'Alkatra';
